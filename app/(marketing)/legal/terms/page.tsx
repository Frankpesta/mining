...
export const metadata: Metadata = {
  title: "Terms & Conditions | blockhashpro",
  description: "Terms and conditions for using blockhashpro mining platform",
};
        ...
        <section className="mt-8 space-y-6">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              By accessing and using blockhashpro ("the Platform", "we", "us", "our"), you accept
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              blockhashpro provides cloud-based cryptocurrency mining services, allowing users to
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              All content, features, and functionality of the Platform are owned by blockhashpro and
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              You agree to indemnify and hold blockhashpro harmless from any claims, damages,
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              jurisdiction in which blockhashpro operates, without regard to conflict of law
              provisions.
            </p>
          </div>
